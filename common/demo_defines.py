...
BUSINESS_DEMOS = {
    "Industrial": [
        ...
        DEMO_GESTURE, DEMO_SURFACE, DEMO_PC_CLASS, DEMO_LEVEL_SENSING, DEMO_1D_SENSING, DEMO_GROUND_SPEED, DEMO_CALIBRATION, DEMO_EBIKES, DEMO_REPLAY, DEMO_VIDEO_DOORBELL, DEMO_DEBUG_PLOTS, DEMO_TOILET
    ],
    "BAC": [
